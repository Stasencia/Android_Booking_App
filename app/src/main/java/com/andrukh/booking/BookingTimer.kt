...
class BookingTimer(lifecycle: Lifecycle) : LifecycleObserver {

    // The number of seconds counted since the timer started
    var secondsCount = 0
    var visibleSecondsCount = 0
    ...
    private lateinit var runnableInFocus: Runnable
    ...
    fun focusStartTimer() {
        runnableInFocus = Runnable {
            visibleSecondsCount++
            Timber.i("App has been in focus for : $visibleSecondsCount second(s)")
